...
namespace Silica {
	...
	EventReply SSliderInt::onMouseButtonDown(const Geometry& allocatedGeometry, const Vec2& mousePos) {
	...
	EventReply SSliderInt::onMouseButtonUp(const Geometry& allocatedGeometry, const Vec2& mousePos) {
		if (m_isDragging) {
			m_isDragging = false;
