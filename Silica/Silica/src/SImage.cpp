...
namespace Silica {
	...
	void SImage::onDraw(DrawList & outDrawList, const Geometry & allotedGeometry) const {
		...
		outDrawList.vertices.push_back({ {allotedGeometry.position.x, allotedGeometry.position.y}, {0.0f, 0.0f}, m_tintColor });
		outDrawList.vertices.push_back({ {allotedGeometry.position.x + allotedGeometry.size.x, allotedGeometry.position.y}, {1.0f, 0.0f}, m_tintColor });
		outDrawList.vertices.push_back({ {allotedGeometry.position.x + allotedGeometry.size.x, allotedGeometry.position.y + allotedGeometry.size.y}, {1.0f, 1.0f}, m_tintColor });
		outDrawList.vertices.push_back({ {allotedGeometry.position.x, allotedGeometry.position.y + allotedGeometry.size.y}, {0.0f, 1.0f}, m_tintColor });
